...
import pytest
from source_vetspire_v2.source import VetspireV2Stream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VetspireV2Stream, "path", "v0/example_endpoint")
    mocker.patch.object(VetspireV2Stream, "primary_key", "test_primary_key")
    mocker.patch.object(VetspireV2Stream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = VetspireV2Stream()
