...
import pytest
from source_vetspire.source import VetspireStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VetspireStream, "path", "v0/example_endpoint")
    mocker.patch.object(VetspireStream, "primary_key", "test_primary_key")
    mocker.patch.object(VetspireStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = VetspireStream()
